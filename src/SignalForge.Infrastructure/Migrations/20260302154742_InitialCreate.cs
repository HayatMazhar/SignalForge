        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetValue = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImpliedVolatility = table.Column<decimal>(type: "decimal(8,4)", precision: 8, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionsFlows", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentimentScore = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    OptionsScore = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsArticles_Symbol_PublishedAt",
                table: "NewsArticles",
                columns: new[] { "Symbol", "PublishedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_OptionsFlows_Symbol_DetectedAt",
                table: "OptionsFlows",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Signals_Symbol_GeneratedAt",
                table: "Signals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWatchlists_UserId_Symbol",
